...
const baseDialogClasses =
  "relative flex w-full max-w-lg flex-col overflow-hidden rounded-3xl bg-primary text-accent shadow-2xl max-h-[min(90vh,50rem)]";
...
function Modal({
  ...
  return (
    ...
    >
      <div
        role="document"
        className={`${baseDialogClasses} ${dialogClassName}`.trim()}
      >
        {showCloseButton ? (
          <button
            type="button"
            ...
            className={`${baseCloseButtonClasses} ${
